...
class _RestClient implements RestClient {
  ...
  Future<List<ChatMessage>> getChat() async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<ChatMessage>>(
  ...
  @override
  Future<ChatMessage> sendMessage(chat) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(chat.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ChatMessage>(
  ...
  RequestOptions _setStreamType<T>(RequestOptions requestOptions) {    if (T != dynamic &&
